...
public class StatusBarUtils {
     ...
     * @return
     */
    public static int getButtonsBarHeight(Activity activity) {
...
//            tintManager.setStatusBarTintResource(colorId);
    ...
    public static void StatusBarLightMode(Activity activity, @ColorRes int statusBarColor) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            activity.getWindow().setStatusBarColor(activity.getResources().getColor(statusBarColor));
        }
        String carrier = Build.MANUFACTURER;
        if (carrier.toLowerCase().contains("xiaomi")) {
            MIUISetStatusBarLightMode(activity, true);
        } else if (carrier.toLowerCase().contains("meizu")) {
    ...
    /**
     * 状态栏暗色模式，MIUI、flyme或6.0以上版本状态栏黑色文字、图标
     */
    ...
    public static void StatusBarDarkMode(Activity activity, @ColorRes int colorRes) {
    ...
    private static boolean FlymeSetStatusBarLightMode(Window window, boolean dark) {
        ...
        if (window != null) {
            try {
                ...
                Log.d("StatusBarUtil", e.toString());
            }
        }
        return result;
    }
