...
public class AVChatSurface {
    ...
    private void switchRender(String user1, String user2) {
        ...
        //先取消用户的画布
        if (("user_" + resHttpLoginBean.getUserInfoId()).equals(user1)) {
            AVChatManager.getInstance().setupLocalVideoRender(null, false, 0);
        } else {
            AVChatManager.getInstance().setupRemoteVideoRender(user1, null, false, 0);
        }
        if (("user_" + resHttpLoginBean.getUserInfoId()).equals(user2)) {
            AVChatManager.getInstance().setupLocalVideoRender(null, false, 0);
        } else {
        ...
        //重新设置上画布
        if (user1.equals(("user_" + resHttpLoginBean.getUserInfoId()))) {
        ...
        if (user2.equals(("user_" + resHttpLoginBean.getUserInfoId()))) {
