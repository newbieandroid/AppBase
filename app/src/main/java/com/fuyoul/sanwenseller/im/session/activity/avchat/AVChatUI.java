...
import com.fuyoul.sanwenseller.im.session.widgets.MultiSelectDialog;
...
//        notifyOption.forceKeepCalling = false;
        ...
        AVChatManager.getInstance().call2(account, callTypeEnum, notifyOption, new AVChatCallback<AVChatData>() {
            ...
            public void onSuccess(AVChatData data) {
                ...
                if (callTypeEnum == AVChatType.VIDEO) {
                    ...
                    initLargeSurfaceView("user_" + DataSupport.findFirst(ResLoginInfoBean.class).getUserInfoId());
        ...
        if (isRecording) {
            ...
            if (recordList.size() == 3) {
                ...
                if (recordList.get(1).second) {
                    AVChatManager.getInstance().stopAVRecording("user_" + DataSupport.findFirst(ResLoginInfoBean.class).getUserInfoId());
                }
                        ...
                        public void onClick(View view) {
                            ...
                            if (selectDialogList.size() == 3) {
                                ...
                                if (selectDialogList.get(1).second) {
                                    AVChatManager.getInstance().startAVRecording("user_" + DataSupport.findFirst(ResLoginInfoBean.class).getUserInfoId());
                                }
    ...
    public void initAllSurfaceView(String largeAccount) {
        ...
        avChatSurface.initSmallSurfaceView("user_" + DataSupport.findFirst(ResLoginInfoBean.class).getUserInfoId());
    }
