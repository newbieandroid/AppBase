...
import com.youquan.selector.engine.ImageEngine;
import com.youquan.selector.filter.Filter;
import com.youquan.selector.internal.entity.CaptureStrategy;
import com.youquan.selector.internal.entity.SelectionSpec;
import com.youquan.selector.ui.MatisseActivity;
...
public final class SelectionCreator {
     ...
     * @return
     */
    public SelectionCreator lastSelectPath(List<String> selectPath) {

        if (selectPath != null) {
            mSelectionSpec.selectPath = selectPath;
        }
        return this;
    }
