 ...
 */
package com.youquan.selector.internal.ui.adapter;
...
import com.youquan.selector.internal.ui.widget.MediaGrid;
...
public class AlbumMediaAdapter extends
    ...
    public void setLastSelectData(List<String> data) {
        ...
        if (mSelectionSpec.countable) {
            ...
            if (data != null && data.size() > 0) {
                ...
                for (String result : data) {
                    ...
                    if (getRealFilePath(context, item.getContentUri()).equals(result)) {
                        mSelectedCollection.add(item);

                        checkedNum = mSelectedCollection.checkedNumOf(item);
                        break;
                    }
                }
            ...
            if (data != null && data.size() > 0) {
                ...
                for (String result : data) {
                    if (getRealFilePath(context, item.getContentUri()).equals(result)) {
                        mSelectedCollection.add(item);
                        selected = mSelectedCollection.isSelected(item);
                        break;
                    }
                }
            }
